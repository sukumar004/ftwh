    ...
    <div className="about-us-top-parent">
      ...
      <div className="about-us">
        ...
        <div className="about-us-contents">
          ...
          <p>This is SUKUMAR from trichy. It is developed only for entertainment and practicing.</p>
          <h5>Tech stacks: HTML5, CSS3, javaScript, React framework & redux toolkit also used for State Management</h5>
